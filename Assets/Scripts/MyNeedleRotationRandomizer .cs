...
namespace UnityEngine.Perception.Randomization.Randomizers.SampleRandomizers
{
    ...
    /// </summary>
    [Serializable]
    [AddRandomizerMenu("Perception/My Needle Rotation Randomizer")]
    public class MyNeedleRotationRandomizer : Randomizer
    {
        /// <summary>
        ...
        {
            var tags = tagManager.Query<NeedleRotationRandomizerTag>();
            foreach (var tag in tags)
            {
                tag.transform.Rotate(rotation.Sample());
